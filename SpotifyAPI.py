...
class SpotifyAPI:
    ...
    def trackSeveral(self, ids, lst):
        ...
        for track in r['tracks']:
            lst.append(
                {'spotify_id': track['id'], 'spotify_name': track['name'], 'spotify_popularity': track['popularity']})
...
def __getTrackData(handler):
    ...
    for i, v in enumerate(isrc):
        ...
        entry = {'isrc': v, 'song_name': names[i], 'spotify_id': spotify_id, 'spotify_href': spotify_href,
